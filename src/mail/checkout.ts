...
export function checkoutMail(cart: any) {
  const titulo = `<div><img style="width: 90px;" src="https://res.cloudinary.com/markets-center/image/upload/v1650312012/htdz8e4zhdkdhxmrcxvh.png" alt="MC"/><h1>Tu compra número ${cart._id} de realizó con éxito</h1></div>`;
  let productos = ``
